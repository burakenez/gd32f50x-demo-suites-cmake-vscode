[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32f50x-demo-suites-cmake-vscode)](https://github.com/burakenez/gd32f50x-demo-suites-cmake-vscode/tags/)

# GD32F50x Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32F50x Demo Suites CMake Visual Studio Code** repository! This project is designed to integrate the CMake build system with Visual Studio Code, providing a streamlined development environment for **_GD32F50x Demo Suites V1.0.1_**.
...
- **🧩 Lightweight Templates:** A structured and organized template for GD32F50x microcontroller projects.
...
- **Notes:**
  ...
  - Update paths in these files if necessary:
    - `Projects/<BoardName>/<ProjectName>/.vscode/launch.json` (lines 14, 17):
      ...
      ```
      ```json
      "${workspaceFolder}/../../../Tools/xpack-openocd-0.11.0-3/scripts/target/openocd_gdlink_gd32f50x.cfg"
      ```
...
- Extracted from `GD32F50x Demo Suites V1.0.1`
...
git clone --recursive https://github.com/burakenez/gd32f50x-demo-suites-cmake-vscode.git
```
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32f50x_it.h  # Interrupt handler declarations specific to GD32F50x.
│           │   │   │   ├── gd32f50x_libopt.h  # Library options and configurations for efficient use.
│           │   │   │   └── systick.h  # Definitions and declarations related to the SysTick timer.
│           │   │   ├── Src
│           │   │   │   ├── gd32f50x_it.c  # Interrupt service routine implementations.
│           │   │   │   ├── main.c  # Entry point of the application, containing the main logic and system initialization.
│           │   │   │   ├── system_gd32f50x.c  # System initialization, clock setup, and core configurations.
│           │   │   │   └── systick.c  # SysTick timer setup and related functionalities.
│           │   ├── Startup
│           │   │   └── startup_gd32f50x.s  # Assembly code for initialization and vector table setup.
│           │   ├── User
...
│           ├── Drivers
│           │   ├── BSP/GD32F503V_EVAL  # Board support package configurations and drivers for GD32F503V_EVAL.
│           │   ├── CMSIS  # CMSIS drivers for Cortex-M processors, supporting GD32F50x.
│           │   └── GD32F50x_standard_peripheral  # Peripheral library for GD32F50x.
...
│           ├── gd32f50x_flash.ld  # Linker script for defining memory regions and placements.
│           └── GD32F50x.svd  # System View Description file for debugging and register definitions. 
